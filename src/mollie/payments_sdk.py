...
class PaymentsSDK(BaseSDK):
    ...
    def list(
        ...
        *,
        ...
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> Optional[models.ListPaymentsResponse]:
        r"""List payments
        ...
        def next_func() -> Optional[models.ListPaymentsResponse]:
        ...
        if utils.match_response(http_res, "200", "application/hal+json"):
            return models.ListPaymentsResponse(
    ...
    async def list_async(
        ...
        *,
        ...
        def next_func() -> Awaitable[Optional[models.ListPaymentsResponse]]:
            body = utils.unmarshal_json(http_res.text, Union[Dict[Any, Any], List[Any]])
