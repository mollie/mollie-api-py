...
class ListSubscriptionsResponseTypedDict(TypedDict):
    result: ListSubscriptionsResponseBodyTypedDict


class ListSubscriptionsResponse(BaseModel):
    next: Union[
        Callable[[], Optional[ListSubscriptionsResponse]],
        Callable[[], Awaitable[Optional[ListSubscriptionsResponse]]],
    ]
...
try:
    ListSubscriptionsResponseBody.model_rebuild()
except NameError:
    pass
