...
class ListChargebacksResponseTypedDict(TypedDict):
    result: ListChargebacksResponseBodyTypedDict


class ListChargebacksResponse(BaseModel):
    next: Union[
        Callable[[], Optional[ListChargebacksResponse]],
        Callable[[], Awaitable[Optional[ListChargebacksResponse]]],
    ]
...
try:
    ListChargebacksResponseBody.model_rebuild()
except NameError:
    pass
