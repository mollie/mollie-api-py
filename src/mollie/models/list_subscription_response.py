...
class ListSubscriptionResponse(BaseModel):
    ...
    **Please note:** the description needs to be unique for the Customer in case it has multiple active subscriptions.
    ...
    def serialize_status(self, value):
        if isinstance(value, str):
            try:
                return models.ListSubscriptionResponseStatus(value)
            except ValueError:
                return value
        return value
    ...
    def serialize_method(self, value):
        if isinstance(value, str):
            try:
                return models.SubscriptionMethodResponse(value)
            except ValueError:
                return value
        return value
    ...
    def serialize_model(self, handler):
        optional_fields = set(
            ["nextPaymentDate", "applicationFee", "mandateId", "canceledAt"]
        )
        nullable_fields = set(
            [
                "times",
...
try:
    ListSubscriptionResponseLinks.model_rebuild()
except NameError:
    pass
try:
    ListSubscriptionResponse.model_rebuild()
except NameError:
    pass
