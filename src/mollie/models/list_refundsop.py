...
class ListRefundsResponseTypedDict(TypedDict):
    result: ListRefundsResponseBodyTypedDict


class ListRefundsResponse(BaseModel):
    next: Union[
        Callable[[], Optional[ListRefundsResponse]],
        Callable[[], Awaitable[Optional[ListRefundsResponse]]],
    ]
...
try:
    ListRefundsResponseBody.model_rebuild()
except NameError:
    pass
