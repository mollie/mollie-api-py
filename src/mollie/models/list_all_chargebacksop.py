...
class ListAllChargebacksResponseTypedDict(TypedDict):
    result: ListAllChargebacksResponseBodyTypedDict


class ListAllChargebacksResponse(BaseModel):
    next: Union[
        Callable[[], Optional[ListAllChargebacksResponse]],
        Callable[[], Awaitable[Optional[ListAllChargebacksResponse]]],
    ]
...
try:
    ListAllChargebacksResponseBody.model_rebuild()
except NameError:
    pass
