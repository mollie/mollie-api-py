...
class ListEntitySettlementLinks(BaseModel):
    ...
    def serialize_model(self, handler):
        optional_fields = set(
            ["payments", "captures", "refunds", "chargebacks", "invoice"]
        )
...
class ListEntitySettlement(BaseModel):
    ...
    def serialize_status(self, value):
        if isinstance(value, str):
            try:
                return models.ListEntitySettlementStatus(value)
            except ValueError:
                return value
        return value
...
try:
    ListEntitySettlementCost.model_rebuild()
except NameError:
    pass
try:
    ListEntitySettlementRevenue.model_rebuild()
except NameError:
    pass
try:
    ListEntitySettlementPeriods.model_rebuild()
except NameError:
    pass
try:
    ListEntitySettlementLinks.model_rebuild()
except NameError:
    pass
try:
    ListEntitySettlement.model_rebuild()
except NameError:
    pass
