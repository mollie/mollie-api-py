...
class ListPaymentsResponseTypedDict(TypedDict):
    result: ListPaymentsResponseBodyTypedDict


class ListPaymentsResponse(BaseModel):
    next: Union[
        Callable[[], Optional[ListPaymentsResponse]],
        Callable[[], Awaitable[Optional[ListPaymentsResponse]]],
    ]
...
try:
    ListPaymentsResponseBody.model_rebuild()
except NameError:
    pass
