...
class ListSubscriptionPaymentsResponse(BaseModel):
    next: Union[
        Callable[[], Optional[ListSubscriptionPaymentsResponse]],
        Callable[[], Awaitable[Optional[ListSubscriptionPaymentsResponse]]],
    ]
...
try:
    ListSubscriptionPaymentsResponseBody.model_rebuild()
except NameError:
    pass
