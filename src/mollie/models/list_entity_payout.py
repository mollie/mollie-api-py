...
class ListEntityPayoutLinksTypedDict(TypedDict):
...
class ListEntityPayoutLinks(BaseModel):
    r"""An object with several relevant URLs. Every URL object will contain an `href` and a `type` field."""
...
class ListEntityPayoutTypedDict(TypedDict):
    resource: str
    ...
    """
    links: NotRequired[ListEntityPayoutLinksTypedDict]
    r"""An object with several relevant URLs. Every URL object will contain an `href` and a `type` field."""


class ListEntityPayout(BaseModel):
    resource: str
    r"""Indicates the response contains a payout object. Will always contain the string `payout` for this endpoint."""
    ...
    links: Annotated[
        Optional[ListEntityPayoutLinks], pydantic.Field(alias="_links")
    ] = None
    r"""An object with several relevant URLs. Every URL object will contain an `href` and a `type` field."""
...
try:
    ListEntityPayoutLinks.model_rebuild()
except NameError:
    pass
try:
    ListEntityPayout.model_rebuild()
except NameError:
    pass
