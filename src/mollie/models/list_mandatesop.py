...
class ListMandatesResponseTypedDict(TypedDict):
    result: ListMandatesResponseBodyTypedDict


class ListMandatesResponse(BaseModel):
    next: Union[
        Callable[[], Optional[ListMandatesResponse]],
        Callable[[], Awaitable[Optional[ListMandatesResponse]]],
    ]
...
try:
    ListMandatesResponseBody.model_rebuild()
except NameError:
    pass
