...
class GetBusinessAccountGlobalsTypedDict(TypedDict):
...
class GetBusinessAccountGlobals(BaseModel):
    testmode: Annotated[
        Optional[bool],
...
class GetBusinessAccountRequestTypedDict(TypedDict):
...
class GetBusinessAccountRequest(BaseModel):
