...
class ListTerminalsResponse(BaseModel):
    next: Union[
        Callable[[], Optional[ListTerminalsResponse]],
        Callable[[], Awaitable[Optional[ListTerminalsResponse]]],
    ]
...
try:
    ListTerminalsResponseBody.model_rebuild()
except NameError:
    pass
