...
class ListSalesInvoiceResponseLinks(BaseModel):
    ...
    def serialize_model(self, handler):
        optional_fields = set(["self", "invoicePayment", "pdfLink", "next", "previous"])
...
class ListSalesInvoiceResponse(BaseModel):
    ...
    vat_mode: Annotated[
        Optional[SalesInvoiceVatModeResponse], pydantic.Field(alias="vatMode")
    ] = None
    r"""The VAT mode to use for VAT calculation. `exclusive` mode means we will apply the relevant VAT on top of the
    price. `inclusive` means the prices you are providing to us already contain the VAT you want to apply.
    """
    ...
    def serialize_status(self, value):
        if isinstance(value, str):
            try:
                return models.SalesInvoiceStatusResponse(value)
            except ValueError:
                return value
        return value
    ...
    def serialize_vat_scheme(self, value):
        if isinstance(value, str):
            try:
                return models.SalesInvoiceVatSchemeResponse(value)
            except ValueError:
                return value
        return value

    @field_serializer("vat_mode")
    def serialize_vat_mode(self, value):
        if isinstance(value, str):
            try:
                return models.SalesInvoiceVatModeResponse(value)
            except ValueError:
                return value
        return value

    @field_serializer("payment_term")
    def serialize_payment_term(self, value):
        if isinstance(value, str):
            try:
                return models.SalesInvoicePaymentTermResponse(value)
            except ValueError:
                return value
        return value
...
try:
    ListSalesInvoiceResponseLinks.model_rebuild()
except NameError:
    pass
try:
    ListSalesInvoiceResponse.model_rebuild()
except NameError:
    pass
