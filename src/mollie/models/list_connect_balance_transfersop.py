...
class ListConnectBalanceTransfersResponse(BaseModel):
    next: Union[
        Callable[[], Optional[ListConnectBalanceTransfersResponse]],
        Callable[[], Awaitable[Optional[ListConnectBalanceTransfersResponse]]],
    ]
...
try:
    ListConnectBalanceTransfersResponseBody.model_rebuild()
except NameError:
    pass
