...
class Organization(BaseModel):
    ...
    def serialize_model(self, handler):
        optional_fields = set(
            ["name", "address", "registrationNumber", "vatNumber", "vatRegulation"]
        )
        nullable_fields = set(["vatNumber", "vatRegulation"])
...
class Profile(BaseModel):
    ...
    def serialize_model(self, handler):
        optional_fields = set(
            ["name", "url", "email", "phone", "description", "businessCategory"]
        )
...
class SubmitOnboardingDataRequestBody(BaseModel):
    ...
    @model_serializer(mode="wrap")
    def serialize_model(self, handler):
        optional_fields = set(["organization", "profile"])
        serialized = handler(self)
        m = {}
