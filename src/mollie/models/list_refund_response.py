...
class ListRefundResponseStatus(str, Enum, metaclass=utils.OpenEnumMeta):
    QUEUED = "queued"
    PENDING = "pending"
...
class ListRefundResponseExternalReferenceTypedDict(TypedDict):
...
class ListRefundResponseExternalReference(BaseModel):
...
class ListRefundResponseSourceTypedDict(TypedDict):
    r"""Where the funds will be pulled back from."""

    organization_id: NotRequired[str]


class ListRefundResponseSource(BaseModel):
    r"""Where the funds will be pulled back from."""
...
class ListRefundResponseRoutingReversalTypedDict(TypedDict):
    amount: NotRequired[AmountTypedDict]
    r"""In v2 endpoints, monetary amounts are represented as objects with a `currency` and `value` field."""
    source: NotRequired[ListRefundResponseSourceTypedDict]
    r"""Where the funds will be pulled back from."""


class ListRefundResponseRoutingReversal(BaseModel):
    amount: Optional[Amount] = None
    r"""In v2 endpoints, monetary amounts are represented as objects with a `currency` and `value` field."""

    source: Optional[ListRefundResponseSource] = None
    r"""Where the funds will be pulled back from."""
...
class ListRefundResponseLinksTypedDict(TypedDict):
...
class ListRefundResponseLinks(BaseModel):
    r"""An object with several relevant URLs. Every URL object will contain an `href` and a `type` field."""
...
class ListRefundResponseTypedDict(TypedDict):
    resource: str
    ...
    links: ListRefundResponseLinksTypedDict
    r"""An object with several relevant URLs. Every URL object will contain an `href` and a `type` field."""
    ...
    external_reference: NotRequired[ListRefundResponseExternalReferenceTypedDict]
    routing_reversals: NotRequired[
        Nullable[List[ListRefundResponseRoutingReversalTypedDict]]
    ]
...
class ListRefundResponse(BaseModel):
    resource: str
    r"""Indicates the response contains a refund object. Will always contain the string `refund` for this endpoint."""
    ...
    links: Annotated[ListRefundResponseLinks, pydantic.Field(alias="_links")]
    r"""An object with several relevant URLs. Every URL object will contain an `href` and a `type` field."""
    ...
    external_reference: Annotated[
        Optional[ListRefundResponseExternalReference],
        pydantic.Field(alias="externalReference"),
    ] = None

    routing_reversals: Annotated[
        OptionalNullable[List[ListRefundResponseRoutingReversal]],
    ...
    def serialize_status(self, value):
        if isinstance(value, str):
            try:
                return models.ListRefundResponseStatus(value)
            except ValueError:
                return value
        return value
...
try:
    ListRefundResponseSource.model_rebuild()
except NameError:
    pass
try:
    ListRefundResponseLinks.model_rebuild()
except NameError:
    pass
try:
    ListRefundResponse.model_rebuild()
except NameError:
    pass
