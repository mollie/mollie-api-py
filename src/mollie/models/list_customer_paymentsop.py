...
class ListCustomerPaymentsResponseTypedDict(TypedDict):
    result: ListCustomerPaymentsResponseBodyTypedDict


class ListCustomerPaymentsResponse(BaseModel):
    next: Union[
        Callable[[], Optional[ListCustomerPaymentsResponse]],
        Callable[[], Awaitable[Optional[ListCustomerPaymentsResponse]]],
    ]
...
try:
    ListCustomerPaymentsResponseBody.model_rebuild()
except NameError:
    pass
