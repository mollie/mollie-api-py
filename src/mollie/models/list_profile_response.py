...
class ListProfileResponseReview(BaseModel):
    ...
    status: Optional[ProfileReviewStatusResponse] = None
    r"""The status of the requested changes."""
    ...
    def serialize_status(self, value):
        if isinstance(value, str):
            try:
                return models.ProfileReviewStatusResponse(value)
            except ValueError:
                return value
        return value
...
class ListProfileResponse(BaseModel):
    ...
    def serialize_status(self, value):
        if isinstance(value, str):
            try:
                return models.ListProfileResponseStatus(value)
            except ValueError:
                return value
        return value
    ...
    @model_serializer(mode="wrap")
    def serialize_model(self, handler):
        optional_fields = set(["description", "countriesOfActivity", "review"])
        serialized = handler(self)
        m = {}
...
try:
    ListProfileResponseLinks.model_rebuild()
except NameError:
    pass
try:
    ListProfileResponse.model_rebuild()
except NameError:
    pass
