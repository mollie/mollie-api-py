...
class ListEntityBalance(BaseModel):
    ...
    def serialize_currency(self, value):
        if isinstance(value, str):
            try:
                return models.ListEntityBalanceCurrency(value)
            except ValueError:
                return value
        return value
    ...
    def serialize_status(self, value):
        if isinstance(value, str):
            try:
                return models.ListEntityBalanceStatus(value)
            except ValueError:
                return value
        return value
    ...
    def serialize_transfer_frequency(self, value):
        if isinstance(value, str):
            try:
                return models.ListEntityBalanceTransferFrequency(value)
            except ValueError:
                return value
        return value
...
try:
    ListEntityBalanceTransferDestination.model_rebuild()
except NameError:
    pass
try:
    ListEntityBalanceLinks.model_rebuild()
except NameError:
    pass
try:
    ListEntityBalance.model_rebuild()
except NameError:
    pass
