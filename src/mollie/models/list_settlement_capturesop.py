...
class ListSettlementCapturesResponse(BaseModel):
    next: Union[
        Callable[[], Optional[ListSettlementCapturesResponse]],
        Callable[[], Awaitable[Optional[ListSettlementCapturesResponse]]],
    ]
...
try:
    ListSettlementCapturesResponseBody.model_rebuild()
except NameError:
    pass
