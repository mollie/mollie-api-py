...
class SalesInvoiceResponseLinks(BaseModel):
    ...
    def serialize_model(self, handler):
        optional_fields = set(
            ["self", "invoicePayment", "pdfLink", "documentation", "next", "previous"]
        )
...
try:
    SalesInvoiceResponseLinks.model_rebuild()
except NameError:
    pass
try:
    SalesInvoiceResponse.model_rebuild()
except NameError:
    pass
