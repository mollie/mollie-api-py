...
class ListSettlementChargebacksResponse(BaseModel):
    next: Union[
        Callable[[], Optional[ListSettlementChargebacksResponse]],
        Callable[[], Awaitable[Optional[ListSettlementChargebacksResponse]]],
    ]
...
try:
    ListSettlementChargebacksResponseBody.model_rebuild()
except NameError:
    pass
