...
class PaymentLinkResponse(BaseModel):
    ...
    allowed_methods: Annotated[
        Nullable[List[PaymentLinkMethodResponse]],
    ...
    sequence_type: Annotated[
        Optional[PaymentLinkSequenceTypeResponse], pydantic.Field(alias="sequenceType")
    ] = None
    ...
    def serialize_sequence_type(self, value):
        if isinstance(value, str):
            try:
                return models.PaymentLinkSequenceTypeResponse(value)
            except ValueError:
                return value
        return value
...
try:
    PaymentLinkResponseLinks.model_rebuild()
except NameError:
    pass
try:
    PaymentLinkResponse.model_rebuild()
except NameError:
    pass
