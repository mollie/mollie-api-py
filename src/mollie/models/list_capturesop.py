...
class ListCapturesResponseTypedDict(TypedDict):
    result: ListCapturesResponseBodyTypedDict


class ListCapturesResponse(BaseModel):
    next: Union[
        Callable[[], Optional[ListCapturesResponse]],
        Callable[[], Awaitable[Optional[ListCapturesResponse]]],
    ]
...
try:
    ListCapturesResponseBody.model_rebuild()
except NameError:
    pass
