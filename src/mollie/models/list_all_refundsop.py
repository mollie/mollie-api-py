...
class ListAllRefundsResponse(BaseModel):
    next: Union[
        Callable[[], Optional[ListAllRefundsResponse]],
        Callable[[], Awaitable[Optional[ListAllRefundsResponse]]],
    ]
...
try:
    ListAllRefundsResponseBody.model_rebuild()
except NameError:
    pass
