...
class Balances(BaseSDK):
    def list(
        ...
        *,
    ...
    ) -> Optional[models.ListBalancesResponse]:
        r"""List balances
            ...
            hook_ctx=HookContext(
                ...
                extensions={
                    "x-readme": {
                        "code-samples": [
                            {
                                "code": 'curl -X GET https://api.mollie.com/v2/balances \\\n    -H "Authorization: Bearer access_Wwvu7egPcJLLJ9Kb7J632x8wJ2zMeJ"',
                                "language": "shell",
                            },
                            {
        ...
        def next_func() -> Optional[models.ListBalancesResponse]:
        ...
        if utils.match_response(http_res, "200", "application/hal+json"):
            return models.ListBalancesResponse(
    ...
    async def list_async(
        ...
        *,
        ...
        def next_func() -> Awaitable[Optional[models.ListBalancesResponse]]:
            body = utils.unmarshal_json(http_res.text, Union[Dict[Any, Any], List[Any]])
            ...
            hook_ctx=HookContext(
                ...
                extensions={
                    "x-readme": {
                        "code-samples": [
                            {
                                "code": 'curl -X GET https://api.mollie.com/v2/balances/bal_gVMhHKqSSRYJyPsuoPNFH \\\n    -H "Authorization: Bearer access_Wwvu7egPcJLLJ9Kb7J632x8wJ2zMeJ"',
                                "language": "shell",
                            },
                            {
            ...
            hook_ctx=HookContext(
                ...
                extensions={
                    "x-readme": {
                        "code-samples": [
                            {
                                "code": 'curl -X GET https://api.mollie.com/v2/balances/primary \\\n    -H "Authorization: Bearer access_Wwvu7egPcJLLJ9Kb7J632x8wJ2zMeJ"',
                                "language": "shell",
                            },
                            {
    ...
    def get_report(
        ...
        *,
        ...
        :param until: The end date of the report, in `YYYY-MM-DD` format. The until date is 'exclusive', and in Central European Time.
            This means a report with for example `until=2024-02-01` will include transactions up until
            2024-01-31 23:59:59 CET.
        :param grouping: You can retrieve reports in two different formats. With the `status-balances` format, transactions are grouped
            ...
            hook_ctx=HookContext(
                ...
                extensions={
                    "x-readme": {
                        "code-samples": [
                            {
                                "code": 'curl -X GET https://api.mollie.com/v2/balances/bal_gVMhHKqSSRYJyPsuoPNFH/report?from=2024-01-01&until=2024-02-01&grouping=transaction-categories \\\n    -H "Authorization: Bearer access_Wwvu7egPcJLLJ9Kb7J632x8wJ2zMeJ"',
                                "language": "shell",
                            },
                            {
    ...
    def list_transactions(
        ...
        *,
        ...
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> Optional[models.ListBalanceTransactionsResponse]:
            ...
            hook_ctx=HookContext(
                ...
                extensions={
                    "x-readme": {
                        "code-samples": [
                            {
                                "code": 'curl -X GET https://api.mollie.com/v2/balances/bal_gVMhHKqSSRYJyPsuoPNFH/transactions \\\n    -H "Authorization: Bearer access_Wwvu7egPcJLLJ9Kb7J632x8wJ2zMeJ"',
                                "language": "shell",
                            },
                            {
        ...
        def next_func() -> Optional[models.ListBalanceTransactionsResponse]:
            body = utils.unmarshal_json(http_res.text, Union[Dict[Any, Any], List[Any]])
        ...
        response_data: Any = None
        if utils.match_response(http_res, "200", "application/hal+json"):
            return models.ListBalanceTransactionsResponse(
                result=unmarshal_json_response(
    ...
    async def list_transactions_async(
        ...
        *,
        ...
        def next_func() -> Awaitable[Optional[models.ListBalanceTransactionsResponse]]:
            body = utils.unmarshal_json(http_res.text, Union[Dict[Any, Any], List[Any]])
            ...
            return self.list_transactions_async(
                balance_id=balance_id,
                from_=from_,
                limit=limit,
                testmode=testmode,
