...
class RefundsSDK(BaseSDK):
        ...
        *,
        ...
        req = self._build_request(
            ...
            get_serialized_body=lambda: utils.serialize_request_body(
                request.refund_request if request is not None else None,
                False,
                True,
                "json",
    ...
    def list(
        ...
        *,
        ...
        def next_func() -> Optional[models.ListRefundsResponse]:
        ...
        if utils.match_response(http_res, "200", "application/hal+json"):
            return models.ListRefundsResponse(
    ...
    async def list_async(
        ...
        *,
        ...
        def next_func() -> Awaitable[Optional[models.ListRefundsResponse]]:
            body = utils.unmarshal_json(http_res.text, Union[Dict[Any, Any], List[Any]])
    ...
    def all(
        ...
        *,
        ...
        def next_func() -> Optional[models.ListAllRefundsResponse]:
            body = utils.unmarshal_json(http_res.text, Union[Dict[Any, Any], List[Any]])
        ...
        response_data: Any = None
        if utils.match_response(http_res, "200", "application/hal+json"):
            return models.ListAllRefundsResponse(
                result=unmarshal_json_response(
    ...
    async def all_async(
        ...
        *,
        ...
        def next_func() -> Awaitable[Optional[models.ListAllRefundsResponse]]:
            body = utils.unmarshal_json(http_res.text, Union[Dict[Any, Any], List[Any]])
