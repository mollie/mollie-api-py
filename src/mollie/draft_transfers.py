    ...
    def list(
        ...
        *,
        ...
        req = self._build_request(
            ...
            accept_header_value="application/hal+json",
            http_headers=http_headers,
            _globals=models.ListDraftTransfersGlobals(
    ...
    def get(
        ...
        *,
        ...
        req = self._build_request(
            ...
            accept_header_value="application/hal+json",
            http_headers=http_headers,
            _globals=models.GetDraftTransferGlobals(
                testmode=self.sdk_configuration.globals.testmode,
            ),
            security=self.sdk_configuration.security,
            allow_empty_value=None,
    ...
    def cancel(
        ...
        *,
        ...
        request_body: Optional[
            Union[
                models.CancelDraftTransferRequestBody,
                models.CancelDraftTransferRequestBodyTypedDict,
            ]
        ] = None,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        ...
        request = models.CancelDraftTransferRequest(
            ...
            request_body=utils.get_pydantic_model(
                request_body, Optional[models.CancelDraftTransferRequestBody]
            ),
        )
        ...
        req = self._build_request(
            ...
            get_serialized_body=lambda: utils.serialize_request_body(
                ...
                True,
                "json",
                Optional[models.CancelDraftTransferRequestBody],
            ),
            allow_empty_value=None,
            allowed_fields=["advanced_access_token", "o_auth"],
            timeout_ms=timeout_ms,
