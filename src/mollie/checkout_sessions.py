...
class CheckoutSessions(BaseSDK):
                ...
                extensions={
                    "x-readme": {
                        "code-samples": [
                            ...
                            {
                                "code": 'import mollie\nfrom mollie import ClientSDK\n\nwith ClientSDK(\n    security=mollie.Security(\n        api_key="live_dHar4XY7LxsDOtmnkVtjNVWXLSlXsM",\n    ),\n) as client_sdk:\n    session = client_sdk.sessions.create(session_request=mollie.SessionRequest(\n        amount=mollie.Amount(\n            currency="EUR",\n            value="10.00",\n        ),\n        description="Order #12345",\n        lines=[\n            mollie.SessionLineItem(\n                description="T-shirt",\n                quantity=1,\n                unit_price=mollie.Amount(\n                    currency="EUR",\n                    value="10.00",\n                ),\n                total_amount=mollie.Amount(\n                    currency="EUR",\n                    value="10.00",\n                ),\n            ),\n        ],\n        redirect_url="https://webshop.example.org/order/12345/",\n    ))',
                                "language": "python",
                            },
    ...
    def get(
        ...
        *,
        ...
        :param session_id: Provide the ID of the related Checkout Session.
        :param idempotency_key: A unique key to ensure idempotent requests. This key should be a UUID v4 string.
        :param retries: Override the default retry configuration for this method
        :param server_url: Override the default server URL for this method
        :param timeout_ms: Override the default request timeout configuration for this method in milliseconds
