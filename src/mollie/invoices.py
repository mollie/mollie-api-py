...
class Invoices(BaseSDK):
    def list(
        ...
        *,
    ...
    ) -> Optional[models.ListInvoicesResponse]:
        r"""List invoices
        ...
        def next_func() -> Optional[models.ListInvoicesResponse]:
        ...
        if utils.match_response(http_res, "200", "application/hal+json"):
            return models.ListInvoicesResponse(
    ...
    async def list_async(
        ...
        *,
        ...
        def next_func() -> Awaitable[Optional[models.ListInvoicesResponse]]:
            body = utils.unmarshal_json(http_res.text, Union[Dict[Any, Any], List[Any]])
