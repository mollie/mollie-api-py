...
<!-- UsageSnippet language="python" operationID="create-session" method="post" path="/v2/sessions" example="create-session-201-1" -->
```python
import mollie
...
with ClientSDK(
    ...
    res = client_sdk.checkout_sessions.create(idempotency_key="123e4567-e89b-12d3-a456-426", session_request=mollie.SessionRequest(
...
<!-- UsageSnippet language="python" operationID="create-session" method="post" path="/v2/sessions" example="create-session-201-2" -->
```python
import mollie
from mollie import ClientSDK
import os
...
<!-- UsageSnippet language="python" operationID="create-session" method="post" path="/v2/sessions" example="create-session-201-3" -->
```python
import mollie
from mollie import ClientSDK
import os
...
<!-- UsageSnippet language="python" operationID="create-session" method="post" path="/v2/sessions" example="create-session-201-4" -->
```python
import mollie
from mollie import ClientSDK
import os
...
<!-- UsageSnippet language="python" operationID="get-session" method="get" path="/v2/sessions/{sessionId}" example="get-session-200-1" -->
```python
import mollie
from mollie import ClientSDK
import os
...
with ClientSDK(
    ...
    res = client_sdk.checkout_sessions.get(session_id="sess_82jFYDTrLcCQV68NLDvMJ", idempotency_key="123e4567-e89b-12d3-a456-426")
...
| Parameter                                                                        | Type                                                                             | Required                                                                         | Description                                                                      | Example                                                                          |
| -------------------------------------------------------------------------------- | -------------------------------------------------------------------------------- | -------------------------------------------------------------------------------- | -------------------------------------------------------------------------------- | -------------------------------------------------------------------------------- |
| `session_id`                                                                     | *str*                                                                            | :heavy_check_mark:                                                               | Provide the ID of the related Checkout Session.                                  | sess_82jFYDTrLcCQV68NLDvMJ                                                       |
| `idempotency_key`                                                                | *Optional[str]*                                                                  | :heavy_minus_sign:                                                               | A unique key to ensure idempotent requests. This key should be a UUID v4 string. | 123e4567-e89b-12d3-a456-426                                                      |
| `retries`                                                                        | [Optional[utils.RetryConfig]](../../models/utils/retryconfig.md)                 | :heavy_minus_sign:                                                               | Configuration to override the default retry behavior of the client.              |                                                                                  |
